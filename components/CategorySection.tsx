  ...
  return (
    <div className="w-full bg-gray-900 py-6">
      <div className="max-w-7xl mx-auto px-4 grid grid-cols-2 sm:grid-cols-3 md:grid-cols-6 gap-4">
        ...
        {/* 1. Παιχνίδια */}
        <Link href="/games" className="flex flex-col items-center justify-center space-y-1 group">
        ...
        <Link href="/top-games" className="flex flex-col items-center justify-center space-y-1 group">
        ...
        {/* 3. Live Casino */}
        <Link href="/live-casino" className="flex flex-col items-center justify-center space-y-1 group">
        ...
        {/* 4. Playson */}
        <Link href="/playson" className="flex flex-col items-center justify-center space-y-1 group">
        ...
        {/* 5. Νεα Παιχνίδια */}
        <Link href="/new-games" className="flex flex-col items-center justify-center space-y-1 group">
        ...
        <Link href="/bonus-buy" className="flex flex-col items-center justify-center space-y-1 group">
